...
# Load the dataset
a1 = pd.read_excel("C:\\Users\Anilesh Prajapati\\Desktop\CreditRiskModeling\\case_study1.xlsx")
a2 = pd.read_excel("C:\\Users\Anilesh Prajapati\\Desktop\CreditRiskModeling\\case_study2.xlsx")
...
# FEATURE SELECTION BY CATEGORICAL VARIABLES
...
# Preditt for unseen data
a3 = pd.read_excel("C:\\Users\Anilesh Prajapati\\Desktop\CreditRiskModeling\\Unseen_Dataset.xlsx")
...
kk = df_encoded_unseen.drop(['Approved_Flag'], axis=1)
...
a3.to_excel("C:\\Users\Anilesh Prajapati\\Desktop\CreditRiskModeling\\Final_Prediction.xlsx", index=False)
